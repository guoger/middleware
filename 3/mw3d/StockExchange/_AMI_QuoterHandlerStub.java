...
public class _AMI_QuoterHandlerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements StockExchange.AMI_QuoterHandler
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = StockExchange.AMI_QuoterHandlerOperations.class;
	public void getQuoteByID_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getQuoteByID_excep", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getQuoteByID_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_QuoterHandlerOperations _localServant = (AMI_QuoterHandlerOperations)_so.servant;
			try
			{
				_localServant.getQuoteByID_excep(excep_holder);
	...
	public void getQuoteByID(float ami_return_val)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_os.write_float(ami_return_val);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		else
		{
			...
			try
			{
				_localServant.getQuoteByID(ami_return_val);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void getQuoteByName(float ami_return_val)
	{
		...
		else
		{
			...
			try
			{
				_localServant.getQuoteByName(ami_return_val);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void getQuoteByName_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getQuoteByName_excep", true);
					((org.omg.CORBA_2_3.portable.OutputStream)_os).write_value (excep_holder );
					_is = _invoke(_os);
					return;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getQuoteByName_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_QuoterHandlerOperations _localServant = (AMI_QuoterHandlerOperations)_so.servant;
			try
			{
				_localServant.getQuoteByName_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
